...
function PixelQuill() {
	return (
		...
		>
			<title>Quill</title>
			{/* Feather */}
			<rect x="8" y="0" width="3" height="1" fill="#e8ddd0" />
			<rect x="7" y="1" width="4" height="1" fill="#d4c3a3" />
			<rect x="6" y="2" width="4" height="1" fill="#c9b896" />
			<rect x="5" y="3" width="3" height="1" fill="#b8a47a" />
			{/* Shaft */}
			<rect x="4" y="4" width="2" height="1" fill="#8b7355" />
			<rect x="3" y="5" width="2" height="1" fill="#8b7355" />
			<rect x="2" y="6" width="2" height="1" fill="#8b7355" />
			<rect x="1" y="7" width="2" height="1" fill="#6b5540" />
			{/* Nib */}
			<rect x="0" y="8" width="2" height="1" fill="#2a1810" />
			<rect x="0" y="9" width="1" height="1" fill="#1a0f0a" />
			{/* Ink drops */}
			<rect x="0" y="10" width="1" height="1" fill="#1a0f0a" opacity="0.6" />
			<rect x="2" y="11" width="1" height="1" fill="#1a0f0a" opacity="0.3" />
		</svg>
	);
}
		...
		<div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
			...
			<div className="absolute inset-0 pointer-events-none overflow-hidden">
				{[10, 25, 45, 65, 80, 92].map((x, i) => (
					<FloatingParticle key={x} delay={i * 0.7} x={x} />
				))}
			</div>
							...
							<form onSubmit={handleSubmit} className="space-y-5">
								...
								<div>
									...
									<input
										...
										placeholder="••••••••"
									/>
									<p className="font-label text-[8px] tracking-[0.15em] text-[#6b5540] mt-1.5">
										At least 8 characters to seal the pact
									</p>
								</div>
								...
								>
									{loading ? "Inscribing..." : "Join the Archives"}
								</button>
							</form>
